'use strict';
// Class 'UI' to implement methods for user interface.
class UI {
    // A method to get result table.
    getTableOfSite() {
        return document.getElementById('resultTable');
    }
    // A method to set the UI for today.
    setUIForToday() {
    ...
    // A method to set the UI for all-time.
    setUIForAll() {
    ...
    // A method to set the UI for last week.
    ...
    // A method to set the UI for chart.
    setUIForDonutChart() {
    ...
    // A method to add 'hr' after chart.
    addHrAfterChart() {
        document.getElementById('chart').appendChild(document.createElement('hr'));
    }
    // A method to add 'hr' after table of site.
    ...
    // A method to draw the bar charts.
    drawBarChart(days) {
        d3.select('#barChart').datum(days);
        barChart(days);
    }
    // A method to add the header of the table.
    ...
    // A method to add the restriciton icon.
    ...
    // A method to add block for calendar.
    ...
    // A method to get the date range.
    getDateRange() {
        return {
    ...
    // A method to fill days for bar chart.
